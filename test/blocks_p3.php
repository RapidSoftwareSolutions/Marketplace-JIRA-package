...
$blocksMU[] = ['findUsers', 'GET', '/rest/api/2/user/search'];
$blocksMU[] = ['findUsersWithBrowsePermission', 'GET', '/rest/api/2/user/viewissue/search'];
$blocksMU[] = ['getUserPropertiesKeys', 'GET', '/rest/api/2/user/properties'];
$blocksMU[] = ['deleteUserProperty', 'DELETE', '/rest/api/2/user/properties/{propertyKey}'];
$blocksMU[] = ['setUserProperty', 'PUT', '/rest/api/2/user/properties/{propertyKey}'];
$blocksMU[] = ['getUserProperty', 'GET', '/rest/api/2/user/properties/{propertyKey}'];
