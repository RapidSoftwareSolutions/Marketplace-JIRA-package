    ...
    array (
        ...
        'args' => array (
            ...
            'issueTypeMappings' => array (
                ...
                'info' => 'Issue type mappings. Example {"IsueTypeId":"WorkflowName"}.',
                'required' => false,
            ),
            ...
            'originalIssueTypeMappings' => array (
                'schema' => '{"type":"object","patternProperties":{".+":{"type":"string"}},"additionalProperties":false}',
                'type' => 'JSON',
                'info' => 'Original issue type mappings. Example {"IssueTypeId": "WorkflowName2"}.',
                'required' => false,
            ),
            'draft' => array (
                'schema' => '{"type":"boolean"}',
            ...
            'issueTypes' => array (
                ...
                'type' => 'JSON',
                'info' => 'JSON objects, issue types. Example {"issuetype1": {"name": "issuetypeName","description": "issuetypeDescription","subtask": true,"avatarId": 10002,"iconUrl": "http://example.com/jira/images/icons/issuetypes/task.png"}}.',
                'required' => false,
            ),
        ),
    ),
