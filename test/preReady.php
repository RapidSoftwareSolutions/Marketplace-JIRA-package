...
return array (
    ...
    array (
        ...
        'args' => array (
            'groupname' => array (
                'type' => 'string',
                'info' => '(mandatory) The name of the group to delete.',
                'required' => false,
            ),
            'swapGroup' => array (
                'type' => 'string',
                'info' => 'If you delete a group and content is restricted to that group, the content will be hidden from all users.To prevent this, use this parameter to specify a different group to transfer the restrictions (comments and worklogs only) to.',
                'required' => false,
            ),
        ),
    ),
    array (
        ...
        'method' => 'GET',
        'description' => 'This resource returns a paginated list of users who are members of the specified group and its subgroups.Users in the page are ordered by user names. User of this resource is required to have sysadmin or admin permissions.',
        'example' => '',
        'schema' => '',
        'args' => array (
            'groupname' => array (
    ...
    array (
        ...
        'method' => 'GET',
        'description' => 'Returns a list of users and groups matching query with highlighting. This resource cannot be accessedanonymously.',
        'example' => '',
        'schema' => '',
        'args' => array (
            'query' => array (
            ...
            'maxResults' => array (
                'type' => 'int',
                'info' => 'The maximum number of users to return (defaults to 50). The maximum allowed value is 1000. Ifyou specify a value that is higher than this number, your search results will be truncated.',
                'required' => false,
            ),
            'showAvatar' => array (
                'type' => 'boolean',
            ...
            'fieldId' => array (
                'type' => 'string',
                'info' => 'The custom field id, if this request comes from a custom field, such as a user picker. Optional.',
                'required' => false,
            ),
            'projectId' => array (
                'type' => 'string',
                'info' => 'The list of project ids to further restrict the searchThis parameter can occur multiple times to pass in multiple project ids.Comma separated value is not supported.This parameter is only used when fieldId is present.',
                'required' => false,
            ),
            'issueTypeId' => array (
                'type' => 'string',
                'info' => 'The list of issue type ids to further restrict the search.This parameter can occur multiple times to pass in multiple issue type ids.Comma separated value is not supported.Special values such as -1 (all standard issue types), -2 (all subtask issue types) are supported.This parameter is only used when fieldId is present.',
                'required' => false,
            ),
        ),
    ),
    ...
    array (
        ...
        'method' => 'POST',
        'description' => 'Creates issues or sub-tasks from a JSON representation. Creates many issues in one bulk operation. Creating a sub-task is similar to creating a regular issue. More details can be found in createIssue section:{@link IssueResource#createIssue(IssueUpdateBean)}}.',
        'example' => '',
        'schema' => '',
        'args' => array (
            'issueUpdates' => array (
    ...
    array (
        ...
        'method' => 'GET',
        'description' => 'Returns a full representation of the issue for the given issue key. An issue JSON consists of the issue key, a collection of fields,a link to the workflow transition sub-resource, and (optionally) the HTML rendered values of any fields that support it(e.g. if wiki syntax is enabled for the description or comments). The fields param (which can be specified multiple times) gives a comma-separated list of fieldsto include in the response. This can be used to retrieve a subset of fields.A particular field can be excluded by prefixing it with a minus. By default, all (*all) fields are returned in this get-issue resource. Note: the default is differentwhen doing a jql search -- the default there is just navigable fields (*navigable). The properties param is similar to fields and specifies a comma-separated list of issueproperties to include. Unlike fields, properties are not included by default. To include them allsend ?properties=*all. You can also include only specified properties or exclude some propertieswith a minus (-) sign. JIRA will attempt to identify the issue by the issueIdOrKey path parameter. This can be an issue id,or an issue key. If the issue cannot be found via an exact match, JIRA will also look for the issue in a case-insensitive way, orby looking to see if the issue was moved. In either of these cases, the request will proceed as normal (a 302 or other redirectwill not be returned). The issue key contained in the response will indicate the current value of issue\'s key. The expand param is used to include, hidden by default, parts of response. This can be used to include:. .',
        'example' => '',
        'schema' => '',
        'args' => array (
            'issueIdOrKey' => array (
            ...
            'properties' => array (
                'type' => 'string',
                'info' => 'The list of properties to return for the issue. By default no properties are returned.',
                'required' => false,
            ),
            'fieldsByKeys' => array (
                'type' => 'boolean',
    ...
    array (
        ...
        'args' => array (
            ...
            'deleteSubtasks' => array (
                'type' => 'string',
                'info' => 'A String of true or false indicating that any subtasks should also be deleted.  If theissue has no subtasks this parameter is ignored.  If the issue has subtasks and this parameter is missing or false,then the issue will not be deleted and an error will be returned.',
                'required' => false,
            ),
        ),
    ),
    array (
        ...
        'vendorUrl' => '/rest/api/2/issue/{issueIdOrKey}',
        'method' => 'PUT',
        'description' => 'Edits an issue from a JSON representation. The issue can either be updated by setting explicit the field value(s)or by using an operation to change the field value. The fields that can be updated, in either the fields parameter or the update parameter, can be determinedusing the /rest/api/2/issue/{issueIdOrKey}/editmeta resource.If a field is not configured to appear on the edit screen, then it will not be in the editmeta, and a fieldvalidation error will occur if it is submitted; however connect add-on with admin scope areable to override the screen security. If the issue cannot be edited in JIRA due to its workflow status (i.e. it is closed), then you will not be able to edit it with this method. Specifying a "field_id": field_value in the "fields" is a shorthand for a "set" operation in the "update" section.Field should appear either in "fields" or "update", not in both.',
        'example' => '',
        'schema' => '',
        'args' => array (
            'issueIdOrKey' => array (
            ...
            'notifyUsers' => array (
                ...
                'info' => 'Send the email with notification that the issue was updated to users that watch it.Admin or project admin permissions are required to disable the notification.',
                'required' => false,
            ),
            'overrideScreenSecurity' => array (
                'type' => 'booleanDefault: false',
                'info' => 'Allows to update fields that are not on the screen.Only connect add-on users with admin scope permission are allowed to use this flag.',
                'required' => false,
            ),
            'overrideEditableFlag' => array (
                'type' => 'booleanDefault: false',
                'info' => 'Updates the issue even if the issue is not editable due to being in a status with jira.issue.editable set to false or missing.Only connect add-on users with admin scope permission are allowed to use this flag.',
                'required' => false,
            ),
            'transition' => array (
                'schema' => '{"title":"Transition","type":"object","properties":{"id":{"type":"string"},"name":{"type":"string"},"to":{"title":"Status","type":"object","properties":{"statusColor":{"type":"string"},"description":{"type":"string"},"iconUrl":{"type":"string"},"name":{"type":"string"},"id":{"type":"string"},"statusCategory":{"title":"Status Category","type":"object","properties":{"id":{"type":"integer"},"key":{"type":"string"},"colorName":{"type":"string"},"name":{"type":"string"}},"additionalProperties":false}},"additionalProperties":false},"hasScreen":{"type":"boolean"},"fields":{"type":"object","patternProperties":{".+":{"title":"Field Meta","type":"object","properties":{"required":{"type":"boolean"},"schema":{"title":"Json Type","type":"object","properties":{"type":{"type":"string"},"items":{"type":"string"},"system":{"type":"string"},"custom":{"type":"string"},"customId":{"type":"integer"}},"additionalProperties":false},"name":{"type":"string"},"key":{"type":"string"},"autoCompleteUrl":{"type":"string"},"hasDefaultValue":{"type":"boolean"},"operations":{"type":"array","items":{"type":"string"}},"allowedValues":{"type":"array","items":[]}},"additionalProperties":false,"required":["required"]}},"additionalProperties":false}},"additionalProperties":false}',
    ...
    array (
        ...
        'method' => 'PUT',
        'description' => 'Assigns an issue to a user.You can use this resource to assign issues when the user submitting the request has the assign permission but not theedit issue permission.If the name is "-1" automatic assignee is used.  A null name will remove the assignee.',
        'example' => '',
        'schema' => '',
        'args' => array (
            'issueIdOrKey' => array (
